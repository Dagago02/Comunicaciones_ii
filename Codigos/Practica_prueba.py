...
class Practica_prueba(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practicaprueba", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practicaprueba")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica_prueba")
        ...
        self._GRX_range = Range(0, 30, 0.5, 0, 200)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(K_real)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(K_imag)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 4000, 0.5, 0, 0)
    ...
    def set_K_real(self, K_real):
        self.K_real = K_real
        self.blocks_multiply_const_vxx_1.set_k(self.K_real)
    ...
    def set_K_imag(self, K_imag):
        self.K_imag = K_imag
        self.blocks_multiply_const_vxx_0.set_k(self.K_imag)
...
def main(top_block_cls=Practica_prueba, options=None):
