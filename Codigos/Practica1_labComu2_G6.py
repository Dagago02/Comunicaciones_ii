...
# Title: Practica1_Anchodebanda_DM
# Author: Daniel_Michael
...
class Practica1_labComu2_G6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica1_Anchodebanda_DM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica1_Anchodebanda_DM")
